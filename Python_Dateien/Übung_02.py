...
class RegressionApp:
    ...
    def Regression(self, x, y):
        ...
        self.plot1.grid()
        [x.grid() for x in [self.result_label, self.result_a_label, self.result_b_label, self.result_b_value, self.result_y_label, self.result_x_label, self.result_a1_label, self.result_y_value, self.result_x_value]]
        
    def remove(self):
        [x.grid_remove() for x in [self.result_label, self.result_a_label, self.result_b_label, self.result_b_value, self.result_y_label, self.result_x_label, self.result_a1_label, self.result_y_value, self.result_x_value]]
    ...
    def initialize_gui(self):
        ...
        self.tk_canvas.get_tk_widget().grid(row=6, column=3, columnspan=100, rowspan=24, padx=0, pady=0)
        self.plot1.set_xlabel('x [z.B. Temperatur in °C]') 
        self.plot1.set_ylabel('y [z.B. Widerstand in \u03A9]') 
        ...
        dropDownVariable, menu = create_option_menu(self.root, self.liste_reg_and_interp, self.drop_down_change, row=0, column=10, width=30, font=self.FONT)
        ...
        self.result_b_value = create_label(self.root, "", 3, 13, self.x_antworten_antworten)
        ...
        self.result_x_value = create_label(self.root, "", 4, 15, self.x_antworten_antworten)
